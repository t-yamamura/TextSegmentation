...
class LCseg:
    ...
    def const_segment_borders_info(self, lexical_cohesion_scores):
        ...
        for i in range(0, len(lexical_cohesion_scores) - 2):
            ...
            p_mi = (lexical_cohesion_scores[i] + lexical_cohesion_scores[i + 2] - lexical_cohesion_scores[
                i + 1] * 2) / 2
    ...
    def const_segments_info(self, borders):
        ...
        for border in borders:
            ...
            s = Segment(start=border.after, end=self.options.text_length - 1,
                        length=self.options.text_length - border.after)
            segments.append(s)
